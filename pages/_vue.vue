    ...
    <section class="bg-gray-100">
        <section ref="header" class="slanted-bottom bg-gray-600 h-96 background">
            <div class="container mx-auto flex pt-5 items-center">
                <div class="ubuntu text-xl md:text-2xl text-white"><fa icon="tint" class="text-xl md:text-2xl mr-2 text-teal-400" />windflow.io</div><div class="flex-grow"></div>
            ...
            <div class="container mx-auto mt-10 md:mt-16">
                <div class="text-center">
                    <span class="text-3xl md:text-5xl inter font-medium text-white">Craft an incredible <span class="whitespace-no-wrap">online shop</span> <br/>
